...
let score = 0;
const fruitImages = {
    1: { src: "fruit1.png", size: 120 }, // Smallest (2x larger than before)
    2: { src: "fruit2.png", size: 160 },
    3: { src: "fruit3.png", size: 200 },
    4: { src: "fruit4.png", size: 240 },
    5: { src: "fruit5.png", size: 280 }  // Largest
};
    ...
    for (let i = 0; i < fruits.length; i++) {
        ...
        if (!fruit.resting) {
            ...
            for (let j = 0; j < fruits.length; j++) {
                if (i !== j && isTouchingForStacking(fruit, fruits[j])) {
...
function isTouchingForStacking(fruit1, fruit2) {
    return (
        fruit1.x < fruit2.x + fruit2.width &&
        fruit1.x + fruit1.width > fruit2.x &&
        fruit1.y + fruit1.height <= fruit2.y && // Just above the other fruit
